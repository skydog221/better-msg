...
export default {
  'zh-cn': {
    ...
    'BetterMsg.email':
      '邮箱输入弹窗,标题[title]介绍[content]字体颜色[color][anim]',
    'BetterMsg.url':
      '链接输入弹窗,标题[title]介绍[content]字体颜色[color][anim]',
    'BetterMsg.date':
    ...
    'BetterMsg.openModalAutoClose':
      '覆盖式弹窗,类型[type]标题[title]内容[content]字体颜色[color][anim],[time]秒后自动关闭(填0则不自动关闭)',
    'BetterMsg.openModalRight':
      '右上角通知弹窗,类型[type]内容[content]并在[time]秒后自动关闭,字体颜色[color] ',
